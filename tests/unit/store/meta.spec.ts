...
import { getMetaModule, MUTATION_SET_LAST_OPENED_SPLITS_FILES, ID_MUTATION_SET_LAST_OPENED_SPLITS_FILES, MUTATION_ADD_OPENED_SPLITS_FILE, ID_MUTATION_ADD_OPENED_SPLITS_FILE, MUTATION_SET_LAST_OPENED_TEMPLATE_FILES, ID_MUTATION_SET_LAST_OPENED_TEMPLATE_FILES, MUTATION_ADD_OPENED_TEMPLATE_FILE, ID_MUTATION_ADD_OPENED_TEMPLATE_FILE, ACTION_SET_LAST_OPENED_SPLITS_FILES, ID_ACTION_SET_LAST_OPENED_SPLITS_FILES, ACTION_SET_LAST_OPENED_TEMPLATE_FILES, ID_ACTION_SET_LAST_OPENED_TEMPLATE_FILES, ACTION_ADD_OPENED_TEMPLATE_FILE, ID_ACTION_ADD_OPENED_TEMPLATE_FILE, ACTION_ADD_OPENED_SPLITS_FILE, ID_ACTION_ADD_OPENED_SPLITS_FILE } from '../../../src/store/modules/meta.module';
import { MetaState, RecentlyOpenedSplit, RecentlyOpenedTemplate } from '../../../src/store/states/meta.state';
