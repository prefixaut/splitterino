...
export const ID_HANDLER_REPLACE_LOADED_PLUGINS = 'replaceLoadedPlugins';
export const ID_HANDLER_REPLACE_ENABLED_PLUGINS = 'replaceEnabledPlugins';
...
export const HANDLER_REPLACE_LOADED_PLUGINS = `${SPLITTERINO_NAMESPACE_NAME}/${PLUGINS_MODULE_NAME}/${ID_HANDLER_REPLACE_LOADED_PLUGINS}`;
export const HANDLER_REPLACE_ENABLED_PLUGINS = `${SPLITTERINO_NAMESPACE_NAME}/${PLUGINS_MODULE_NAME}/${ID_HANDLER_REPLACE_ENABLED_PLUGINS}`;
 ...
 * Settings
 */
export const SETTINGS_NAMESPACE_SPLITTERINO = 'splitterino';
export const SETTINGS_COLLECTION_CORE = 'core';
...
export const SETTING_SPLITS_PIN_LAST_SEGMENT = `${SETTINGS_NAMESPACE_SPLITTERINO}.${SETTINGS_COLLECTION_CORE}.${SETTINGS_GROUP_SPLITS}.${SETTING_ID_PIN_LAST_SEGMENT}`;
export const SETTING_SPLITS_VISIBLE_UPCOMING_SEGMENTS = `${SETTINGS_NAMESPACE_SPLITTERINO}.${SETTINGS_COLLECTION_CORE}.${SETTINGS_GROUP_SPLITS}.${SETTING_ID_VISIBLE_UPCOMING_SEGMENTS}`;
export const SETTING_SPLITS_VISIBLE_PREVIOUS_SEGMENTS = `${SETTINGS_NAMESPACE_SPLITTERINO}.${SETTINGS_COLLECTION_CORE}.${SETTINGS_GROUP_SPLITS}.${SETTING_ID_VISIBLE_PREVIOUS_SEGMENTS}`;
export const SETTING_SPLITS_SEGMENT_TIME_FORMAT = `${SETTINGS_NAMESPACE_SPLITTERINO}.${SETTINGS_COLLECTION_CORE}.${SETTINGS_GROUP_SPLITS}.${SETTING_ID_SEGMENT_TIME_FORMAT}`;
export const SETTING_SPLITS_COMPARISON_TIME_FORMAT = `${SETTINGS_NAMESPACE_SPLITTERINO}.${SETTINGS_COLLECTION_CORE}.${SETTINGS_GROUP_SPLITS}.${SETTING_ID_COMPARISON_TIME_FORMAT}`;
export const SETTING_TIMER_FORMAT = `${SETTINGS_NAMESPACE_SPLITTERINO}.${SETTINGS_COLLECTION_CORE}/${SETTINGS_GROUP_TIMER}/${SETTING_ID_FORMAT}`;
export const SETTING_APP_SHOW_TITLE_BAR = `${SETTINGS_NAMESPACE_SPLITTERINO}.${SETTINGS_COLLECTION_CORE}/${SETTINGS_GROUP_APP}/${SETTING_ID_SHOW_TITLE_BAR}`;
