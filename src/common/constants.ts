...
export const ID_HANDLER_SET_SETTINGS_ALL = 'setAllSettings';
export const ID_HANDLER_SET_SETTINGS_BULK = 'setSettingsBulk';
...
export const HANDLER_SET_SETTINGS_ALL = `${SPLITTERINO_NAMESPACE_NAME}/${SETTINGS_MODULE_NAME}/${ID_HANDLER_SET_SETTINGS_ALL}`;
export const HANDLER_SET_SETTINGS_BULK = `${SPLITTERINO_NAMESPACE_NAME}/${SETTINGS_MODULE_NAME}/${ID_HANDLER_SET_SETTINGS_BULK}`;
